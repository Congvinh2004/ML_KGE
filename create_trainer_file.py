"""
Script để tạo file Trainer.py trong Kaggle notebook
Copy toàn bộ code này vào một cell mới trong notebook
"""

trainer_code = '''# coding:utf-8
import torch
...
os.makedirs("openke/config", exist_ok=True)

# Ghi file Trainer.py
with open("openke/config/Trainer.py", 'w', encoding='utf-8') as f:
    f.write(trainer_code)

print("✅ Trainer.py đã được tạo trong workspace!")
print("   → File: openke/config/Trainer.py")
print("   → Không cần patch trong CELL 5.5 nữa")
print("   → Không cần Kaggle Dataset")
